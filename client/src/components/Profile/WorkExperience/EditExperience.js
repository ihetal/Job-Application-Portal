...
export class EditExperience extends Component {
  ...
  componentDidMount() {
    this.setState({
      ...
      employmenttype: this.props.details.employmenttype,
      company: this.props.details.company,
      startmonth: this.props.details.startmonth,
      startyear: this.props.details.startyear,
      endmonth: this.props.details.endmonth,
      endyear: this.props.details.endyear,
      description: this.props.details.description,
    });
    this.props.details.endmonth === ""
      ? this.setState({ defaultcheckboxstatus: true })
      : this.setState({ defaultcheckboxstatus: false });

    setTimeout(() => {
      document.getElementById(
        "defaultCheck1"
      ).checked = this.state.defaultcheckboxstatus;
    }, 500);
  }
  checkBoxClicked = (e) => {
    this.setState({
  ...
  showAddExperience = () => {
    let form = document.getElementById("editexp");
  ...
  render() {
    return (
      <div id="backgrounddiv" className="disableDiv">
        ...
        <div className="addexperience col show" id="editexp">
          <div className="row">
            <h2 className="col mb-3">Edit Experience</h2>
            <i
